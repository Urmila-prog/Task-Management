...
const Chatbot = () => {
  ...
  return (
    <div className="relative">
      ...
      {isOpen && (
        <div className="absolute bottom-full mb-2 right-0 w-96 bg-gray-800 rounded-lg shadow-lg">
                      ...
                      <div className="prose prose-invert prose-sm max-w-none">
                        <ReactMarkdown 
                          ...
                          components={{
                            ...
                            blockquote: ({node, ...props}) => <blockquote className="border-l-4 border-gray-500 pl-4 italic mb-2" {...props} />,
